...
// Smallpt deroulé pour l'enseignement, 
// lancé de rayon iteratif avec echantillonnage des sources,
// et affichage progressif du rendu dans une fenetre Grapic,
// avec possibilité de bouger la camera (mais pas trop). 
// Basile Fraboni 2020.
//
// A utiliser avec la librairie d'enseignement C/C++ Grapic
// Instruction de compilation des projets sur la page de documentation:
// https://perso.liris.cnrs.fr/alexandre.meyer/grapic/html/
// Alexandre Meyer, Université Claude Bernard Lyon 1
//
...
Sphere spheres[] = 
{
    ...
    Sphere(16.5,Vec(27,16.5,47),       Vec(),Vec(1,1,1)*.999,  SPEC, 0.2f),    // Sphere miroir + fuzz
    Sphere(16.5,Vec(73,16.5,78),       Vec(),Vec(1,1,1)*.999,  REFR, 0.2f),    // Sphere verre + fuzz
